...
def gen_improv(matrix, house, swap_allowed, improv_x, improv_y):
    ...
    if decision == 0:
        matrix = move_house(matrix, house, improv_x, improv_y )
    else:
        matrix = swap(matrix, house)

    return matrix

def move_house(matrix, house, improv_x, improv_y ):
